...
This pipeline takes part of the scientific paper: 'Uncovering Transcriptomic Modules in Colorectal Cancer: A Causal Inference Framework for Network-Based Analysis' 

This tool generates bar plots for five gene categories (protein-coding, ribosomal RNA, mitochondrial RNA, and other non-coding RNA),
using count datasets (RAW or NORMALIZED) downloaded from GEO   (e.g., generated with HTSeq count or Subread featureCounts) from Total or poly-A RNAseq libraries.
Pipeline Overview
...
The pipeline calculates the percentage of reads assigned to the five key gene categories defined in the papeer, typically found in datasets generated using a Total RNA protocol.
